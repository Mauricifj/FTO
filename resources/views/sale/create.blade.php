        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                @foreach($products as $product)
                    ...
                    <input type="hidden" id="total_quantity_{{ $product->id }}" value="{{ $product->quantity }}">
                @endforeach
...
@section('scripts')
    <script>
        function addProduct() {
            ...
            let total_quantity = $('#total_quantity_' + product_id).val();
            ...
            products_list.append(
                `<tr class="justify-content-between align-items-center" id="product_row_${product_id}">
                    ...
                    <td>${product_price}</td>
                    <td>
                        <select name="products[${product_id}][quantity]" id="quantity_${product_id}" onchange="updateTotalForProduct(${product_id})">
            ...
            for(var i = 1; i <= total_quantity; i++) {
                $('#quantity_' + product_id).append(`<option value="${i}">${i}</option>`);
            }
